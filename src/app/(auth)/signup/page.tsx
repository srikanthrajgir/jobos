    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-bg-main px-6 py-12">
      <div className="w-full max-w-md bg-bg-card border border-border-light rounded-2xl shadow-xl p-8">
        ...
        <form action={signInWithGoogle} className="mb-6">
          <button type="submit" className="w-full bg-white border border-border-light text-text-charcoal py-3 rounded-xl font-bold hover:bg-gray-50 transition-all flex items-center justify-center shadow-sm">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-bg-card text-text-muted font-medium">Or sign up with email</span>
          </div>
        </div>
